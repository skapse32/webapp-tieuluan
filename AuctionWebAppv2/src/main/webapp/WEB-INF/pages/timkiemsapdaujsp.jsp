...
<form action="${pageContext.request.contextPath}/timkiemsapdau">
	<div class="Column3">
			...
			<table width="100%">
				<tr>
					<td width="70%" align="center"><label style="">Trang
							...
							<a style="color:#00C"
								href="${pageContext.request.contextPath}/timkiemsapdau?trang=${i}&soLuongSanPhamTrenTrang=${soLuongSanPhamTrenTrang}">
