	...
	<div>
		<div class="wrap-dtb">
			<div class="wrap-header">
				...
				<div style="width: 15%">Giá khởi điểm</div>
				<div style="width: 15%">Bước giá</div>
				<div style="width: 20%">Thời gian bắt đầu</div>
				<div style="width: 20%">Lý do hủy</div>
			</div>
			<c:forEach var="sp" items="${dssp}">
				<div class="wrap-td-chan">
					...
					<div
						style="width: 15%;color: #584C46;font-size: 12px;font-weight: bold;padding-top: 10px;">
						<fmt:formatNumber type="currency" currencyCode="VND"
							value="${sp.giakhoidiem}" />
					</div>
					<div
						style="width: 15%;color: #2DAB00;font-size: 14px;padding-top: 10px;font-weight: bold;">
						<fmt:formatNumber type="currency" currencyCode="VND"
							value="${sp.buocgia}" />
					</div>
					<div
						style="width: 20%; font-size: 12px;padding-top: 10px;font-weight: bold; color: #333;">
