	...
	<div>
		<div class="wrap-dtb">
			<div class="wrap-header">
				...
				<div style="width: 16%">Người thắng</div>
			...
			<div class="wrap-td-chan">
				...
				<div style="width: 17%;color: #584C46;font-size: 12px;font-weight: bold;padding-top: 10px;"><fmt:formatNumber type="currency" currencyCode="VND"
							value="${sp.giakhoidiem}" /></div>
				<div style="width: 17%;color: #2DAB00;font-size: 14px;padding-top: 10px;font-weight: bold;"><fmt:formatNumber type="currency" currencyCode="VND"
							value="${sp.giahientai}" /></div>
				<div style="width: 16%;color: #7E7C7C;font-size: 12px;font-weight: bold;text-align: center;padding-top: 10px;">${sp.nguoidat}</div>
				<div style="width: 20%; font-size: 12px;padding-top: 10px;font-weight: bold; color: #333;">
